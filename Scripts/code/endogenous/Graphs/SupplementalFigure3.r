...
SupplementalFigure3 <- ggarrange(combined_plot,all_countries,ncol=1,nrow=2,labels=c("A","B"))
ggsave("SupFig3.pdf", plot = SupplementalFigure4, width = 10, height = 8, units = "in")
