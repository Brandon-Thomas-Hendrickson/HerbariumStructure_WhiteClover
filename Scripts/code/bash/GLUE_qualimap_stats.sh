...
OUTPUT_CSV="/work/calicraw/Projects/HerbariumStructure/aligned/qualimap_reports/GLUE/GLUE_QUALI_STATS.csv"
BAM_DIR="/work/calicraw/Projects/HerbariumStructure/aligned/processed/GLUE"
QUALIDIR="/work/calicraw/Projects/HerbariumStructure/aligned/qualimap_reports/GLUE/qualistats_reports"
...
sed -i 's,/work/calicraw/Projects/HerbariumStructure/aligned/processed/GLUE/,,g' GLUE_bam_list.txt
