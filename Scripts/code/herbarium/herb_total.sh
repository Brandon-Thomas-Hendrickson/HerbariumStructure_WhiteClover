...
TRIMDIR=/work/calicraw/Projects/HerbariumStructure/sequences/trimmed
...
DECONDIR=/work/calicraw/Projects/HerbariumStructure/sequences/clean
...
#Run FastQC
for i in $(cat /work/calicraw/Projects/HerbariumStructure/file_lists/herbarium/herbarium_list.txt);
...
#Run Alignment
for FILE in $(cat /work/calicraw/Projects/HerbariumStructure/file_lists/herbarium/herbarium_list.txt);
...
for FILE in $(cat /work/calicraw/Projects/HerbariumStructure/file_lists/herbarium/herbarium_list.txt);
do 
  /work/calicraw/Software/samtools-1.21/samtools fixmate -@ 48 -m $ALIGNDIR/$FILE'_grouped.bam' $ALIGNDIR/$FILE'_fixmate.bam';
done
...
# Index Bam Files
for FILE in $(cat /work/calicraw/Projects/HerbariumStructure/file_lists/herbarium/herbarium_list.txt); do
