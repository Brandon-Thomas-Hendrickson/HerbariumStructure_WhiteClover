...
#Run FastQC
#for i in $(cat /work/calicraw/Projects/HerbariumStructure/file_lists/herbarium/xae_list.txt);
...
#Run Alignment
for FILE in $(cat /work/calicraw/Projects/HerbariumStructure/file_lists/herbarium/xae_list.txt);
...
# Index Bam Files
for FILE in $(cat /work/calicraw/Projects/HerbariumStructure/file_lists/herbarium/xae_list.txt); do
