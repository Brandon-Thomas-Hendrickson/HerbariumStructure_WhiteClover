...
BAMLIST="/work/calicraw/Projects/HerbariumStructure/file_lists/herbarium/G4_bam_list.txt"
...
$ANGSD -ref $GENOMEREF -fai $GENOME -bam $BAMLIST -SNP_pval 1e-6 -doMajorMinor 4 -minQ 20 -minMapQ 30 -doPost 1 -GL 1 -doGlf 2 -minMaf 0.05 -doCounts 1 -doMaf 2 -P 8 -out $ANGSDDIR/G4_herb
